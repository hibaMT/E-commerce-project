                   ...
                   <div class="register-form form-item">
                     <x-jet-validation-errors class="mb-4" />
                      ...
                      <form class="form-stl"  action="{{ route('register')}}" name="frm-login" method="POST">
                         <figure><img src="assets/images/blogs/banner-shop11.jpg" alt="LUCIA"></figure>
                        @csrf
                        ...
                        <fieldset class="wrap-input">
                            <label for="frm-login-lname"> Name*</label>
                        ...
                        <fieldset class="wrap-input">
                            ...
                            <input type="email" id="frm-login-email" name="email" placeholder="Email address" :value="email" >
                        </fieldset>
